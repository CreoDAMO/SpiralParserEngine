...
export class HTSXMultiAIAgent {
  ...
  private generateResponseContent(model: AIModel, task: HTSXTask): string {
    ...
    const taskDescriptions = {
      ...
      [TaskType.FRONTEND]: "Frontend development and user interface",
      [TaskType.BACKEND]: "Backend services and API development",
      [TaskType.OPTIMIZATION]: "Performance and efficiency optimization",
      [TaskType.TESTING]: "Test design and quality assurance",
      [TaskType.DEPLOYMENT]: "Deployment strategy and automation"
    };
