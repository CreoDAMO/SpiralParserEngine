...
export class FounderWallet {
  ...
  private config!: FounderWalletConfig; // Initialized in constructor via initializeFounderWallet()
  ...
  private walletState!: HybridWalletState; // Initialized in constructor via initializeFounderWallet()
