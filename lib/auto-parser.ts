...
// import { unifiedSpiralParser } from '../generated/UnifiedSpiralParser'; // TODO: Generate this file
...
export class AutoParser {
  ...
  async parseFile(filename: string, content: string): Promise<AutoParseResult> {
    try {
      // Try to use compiled ANTLR4 parser first (currently disabled until generated)
      // const result = await unifiedSpiralParser.parseFile(filename, content);
      
      // Fallback to spiral parser for now
