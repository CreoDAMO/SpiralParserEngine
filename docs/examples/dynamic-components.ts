...
// examples/dynamic-components.ts
...
export const QuantumVisualizer = dynamic(() => import('../components/quantum/QuantumVisualizer'), {
  ssr: false,
  loading: () => (
...
export const MolecularAssembly = dynamic(() => import('../components/molecular/MolecularAssembly'), {
  ssr: false,
  loading: () => (
...
export const BlockchainVisualizer = dynamic(() => import('../components/blockchain/BlockchainVisualizer'), {
  ssr: false,
  loading: () => (
...
export const AIDashboard = dynamic(() => import('../components/ai/AIDashboard'), {
  ssr: false,
  loading: () => (
...
export const TrustUnitGenerator = dynamic(() => import('../components/trust/TrustUnitGenerator'), {
  ssr: false,
  loading: () => (
